  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
      <div className="flex items-center">
        ...
        <span className="ml-3 text-lg font-semibold">Thompson Eno</span>
      </div>
      <div>
          ...
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                Additionally, my media evaluation experience sharpens my insight into content quality and user engagement, bridging technical and strategic aspects. 
                I'm committed to delivering high quality, impactful work.
                </p>
              </div>
